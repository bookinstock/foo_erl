...
% Punctuation
% 1. Commas(,): separate args, data, patterns.
% 2. Perids(.): separate funcs and expressions.
% 3. Semicolons(;): separate clauses, sucn as def, case, if, try, receive
